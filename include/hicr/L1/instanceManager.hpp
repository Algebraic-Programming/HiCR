...
class InstanceManager
{
   ...
   */
  __USED__ inline std::shared_ptr<HiCR::L0::Instance> createInstance(int argc, char **argv, const HiCR::L0::Topology &requestedTopology = HiCR::L0::Topology())
  {
    // Requesting the creating of the instance to the specific backend
    auto newInstance = createInstanceImpl(argc, argv, requestedTopology);
   ...
   * \return A pointer to the newly created instance (if successful), a null pointer otherwise.
   */
  virtual std::shared_ptr<HiCR::L0::Instance> createInstanceImpl(int argc, char **argv, const HiCR::L0::Topology &requestedTopology) = 0;
