 ...
 */
#define HICR_THROW_LOGIC(...) HiCR::common::throwException(HiCR::common::exceptions::exception_t::logic, __FILE__, __LINE__, __VA_ARGS__)
 ...
 * \param[in] ... C-Formatted string and its additional arguments
 */
#define HICR_THROW_RUNTIME(...) HiCR::common::throwException(HiCR::common::exceptions::exception_t::runtime, __FILE__, __LINE__, __VA_ARGS__)
 ...
 * \param[in] ... C-Formatted string and its additional arguments
 */
#define HICR_THROW_FATAL(...) HiCR::common::throwException(HiCR::common::exceptions::exception_t::fatal, __FILE__, __LINE__, __VA_ARGS__)
