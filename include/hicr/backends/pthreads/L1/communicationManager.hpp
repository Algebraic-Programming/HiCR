...
#include <hicr/backends/hwloc/L0/globalMemorySlot.hpp>
...
class CommunicationManager final : public HiCR::L1::CommunicationManager
{
  ...
  __INLINE__ std::shared_ptr<HiCR::L0::GlobalMemorySlot> getGlobalMemorySlotImpl(const HiCR::backend::hwloc::L0::GlobalMemorySlot::tag_t       tag,
                                                                                 const HiCR::backend::hwloc::L0::GlobalMemorySlot::globalKey_t globalKey) override
  {
                                                                                ...
                                                                                HiCR::L0::GlobalMemorySlot::tag_t                 tag) override
  {
    ...
    auto globalMemorySlot = std::make_shared<HiCR::backend::hwloc::L0::GlobalMemorySlot>(tag, 0 /* key */, memorySlot);
  ...
  __INLINE__ void exchangeGlobalMemorySlotsImpl(const HiCR::L0::GlobalMemorySlot::tag_t tag, const std::vector<globalKeyMemorySlotPair_t> &memorySlots) override
  {
    ...
    for (const auto &entry : memorySlots)
    {
      ...
      auto globalMemorySlot = std::make_shared<HiCR::backend::hwloc::L0::GlobalMemorySlot>(tag, globalKey, memorySlot);
  ...
  {
    // Getting up-casted pointer for the execution unit
    auto m = dynamic_pointer_cast<hwloc::L0::GlobalMemorySlot>(memorySlot);
