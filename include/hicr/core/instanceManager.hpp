...
class InstanceManager
{
  ...
  */
   ...
   */
  virtual void launchRPC(HiCR::Instance &instance, const std::string &RPCName) const = 0;
   ...
   */
  __INLINE__ void *getReturnValue(HiCR::Instance &instance) const
  {
    // Calling backend-specific implementation of this function
  ...
  */
   ...
   * \return A pointer to a newly allocated local memory slot containing the return value
   */
  virtual void *getReturnValueImpl(HiCR::Instance &instance) const = 0;
