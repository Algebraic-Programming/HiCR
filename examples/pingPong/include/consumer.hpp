                ...
                )
{
  ...
  communicationManager.exchangeGlobalMemorySlots(CHANNEL_TAG, {{CONSUMER_PING_COORDINATION_BUFFER_KEY, pingCoordinationBuffer}, {CONSUMER_PONG_COORDINATION_BUFFER_KEY, pongCoordinationBuffer}, {PING_BUFFER_KEY, pingBufferSlot}});
