...
void consumerFc(HiCR::L1::MemoryManager* memoryManager, const size_t channelCapacity, const size_t producerCount)
{
 ...
 HiCR::L1::channel::Base::initializeCoordinationBuffer(consumerCoordinationBufferSlot);
 ...
 auto consumer = HiCR::L1::channel::MPSC::Consumer(memoryManager, globalTokenBufferSlot, globalCoordinationBufferSlot, sizeof(ELEMENT_TYPE), channelCapacity);
