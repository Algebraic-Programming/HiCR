...
void memcpy(
  LPFMemorySlot &destination, const size_t dst_locality, const size_t dst_offset, const LPFMemorySlot &source, const size_t src_locality, const size_t src_offset, const size_t size, const TagSlot &tag)
{
