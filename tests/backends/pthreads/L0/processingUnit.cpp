...
{
  auto computeResource = HiCR::backend::hwloc::L0::ComputeResource(0, 0, 0, {});
  auto cPtr            = std::make_shared<HiCR::backend::hwloc::L0::ComputeResource>(computeResource);

  HiCR::backend::pthreads::L0::ProcessingUnit *p = nullptr;
  ASSERT_NO_THROW(p = new HiCR::backend::pthreads::L0::ProcessingUnit(cPtr));
...
TEST(ProcessingUnit, AffinityFunctions)
{
  ...
  std::set<HiCR::backend::hwloc::L0::ComputeResource::logicalProcessorId_t> originalAffinitySet;
  ASSERT_NO_THROW(originalAffinitySet = HiCR::backend::pthreads::L0::ProcessingUnit::getAffinity());

  // Attempting to set and check new affinity set
  std::set<HiCR::backend::hwloc::L0::ComputeResource::logicalProcessorId_t> newAffinitySet({0, 1});
  ASSERT_NO_THROW(HiCR::backend::pthreads::L0::ProcessingUnit::updateAffinity(newAffinitySet));
  ASSERT_EQ(newAffinitySet, HiCR::backend::pthreads::L0::ProcessingUnit::getAffinity());

  // Re-setting affinity set
  ASSERT_NO_THROW(HiCR::backend::pthreads::L0::ProcessingUnit::updateAffinity(originalAffinitySet));
  ASSERT_EQ(originalAffinitySet, HiCR::backend::pthreads::L0::ProcessingUnit::getAffinity());
}
...
TEST(ProcessingUnit, ThreadAffinity)
{
  ...
  std::set<HiCR::backend::hwloc::L0::ComputeResource::logicalProcessorId_t> threadAffinitySet({threadAffinity});
  ...
  auto fc = [&hasCorrectAffinity, &checkedAffinity, &threadAffinitySet](void *arg) {
    ...
    auto actualThreadAffinity = HiCR::backend::pthreads::L0::ProcessingUnit::getAffinity();
...
TEST(ProcessingUnit, LifeCycle)
{
  ...
  // Creating execution unit
  auto executionUnit1 = std::make_shared<HiCR::backend::pthreads::L0::ExecutionUnit>(fc1);
  ...
  // Creating execution unit
  auto executionUnit2 = std::make_shared<HiCR::backend::pthreads::L0::ExecutionUnit>(fc2);
  ...
  // Creating execution unit
  auto executionUnit3 = std::make_shared<HiCR::backend::pthreads::L0::ExecutionUnit>(fc3);
