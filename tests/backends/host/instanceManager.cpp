 ...
 * @brief Unit tests for the host instance manager backend
 * @author S. M. Martin
 * @date 16/8/2024
 */
...
{
  HiCR::backend::host::L1::InstanceManager *im = NULL;

  EXPECT_NO_THROW(im = new HiCR::backend::host::L1::InstanceManager());
...
{
  auto im = HiCR::backend::host::L1::InstanceManager::createDefault(nullptr, nullptr);
